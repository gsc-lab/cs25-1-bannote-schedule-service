...
# # docker build -t ban_note .
# # docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name ban_note ban_note
...
# # Install grpc_service gems


# # Copy application code
# COPY . .

# # Add execute permissions to bin scripts
# RUN chmod +x ./bin/*

# # Fix CRLF line endings in bin scripts
# RUN sed -i 's/\r$//' ./bin/*
...
#     chown -R rails:rails log tmp /usr/local/bundle
# USER 1000:1000
