...
# source: schedule-service/group/group_service.proto
  ...
  module Scheduleservice
    module Group
      module V1
        ...
        GetManyGroupsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("bannote.scheduleservice.group.v1.GetManyGroupsRequest").msgclass
        GetManyGroupsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("bannote.scheduleservice.group.v1.GetManyGroupsResponse").msgclass
      end
    end
  end
end
