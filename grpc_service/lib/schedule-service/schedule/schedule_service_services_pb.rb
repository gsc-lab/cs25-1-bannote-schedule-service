...
# Source: schedule-service/schedule/schedule_service.proto for package 'bannote.scheduleservice.schedule.v1'

require 'grpc'
require 'schedule-service/schedule/schedule_service_pb'
